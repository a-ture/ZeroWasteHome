...
public class ListaSpesa {
   ...
   *
   * <p>Annotato con {@code @Id} per indicare la chiave primaria e con {@code @GeneratedValue} per
   * l'auto-incremento nel database.
   */
  @Id
   ...
   *
   * <p>Relazione {@code ManyToOne} con l'entità Utente, rappresenta l'utente a cui appartiene la
   * lista della spesa.
   */
  @ManyToOne
   ...
   *
   * <p>Relazione {@code ManyToMany} con l'entità Prodotto, rappresenta i prodotti che fanno parte
   * della lista.
   */
  @ManyToMany
  @JoinTable(
