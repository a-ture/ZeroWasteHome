 ...
 *
 * <p>Interfaccia che estende {@code JpaRepository} per la gestione delle operazioni CRUD sull'entità
 * ListaSpesa nel database. Include il metodo {@code findByUtenteId} per recuperare le liste della spesa
