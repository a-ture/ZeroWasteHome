 ...
 *
 * <p>Il controller fornisce gli endpoint per generare una lista della spesa per un utente
 * in base ai suoi articoli disponibili, e per ottenere le liste della spesa di un utente.
 *
